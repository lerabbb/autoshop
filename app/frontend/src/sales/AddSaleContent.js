...
export default function AddSaleContent() {
            ...
            <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
                ...
                <form className="form-inline" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='mb-4'>
                        ...
                        <input 
                            type="number" className="form-control" min="0" max="10000000" step={0.01}
                            placeholder='Цена'
                            {...register("price", {
                                required: "Поле обязательно к заполнению"          
                            })}
                    ...
                    <Link className='btn btn-outline-danger mx-2' to={"/viewsale/"+id}>Отмена</Link>
                </form>
            </div>
        </div>    
    </div>
