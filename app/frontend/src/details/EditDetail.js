...
export default function EditDetail() {
    ...
    useEffect(()=>{
        ...
        setValue("producer.id", detail.producer.id);
        setValue("guarantee", detail.guarantee);
        setValue("size", detail.size || 0);
    }, [detail]);
    ...
    <div className='container'>
        <div className='row'>
            <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
                <h2 className='text-center m-4'>Изменить данные о товаре {detail.id}</h2>
