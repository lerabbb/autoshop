  ...
  <div className="col">
    <div className="card shadow-sm">
      <svg className="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
        ...
        <text x="50%" y="50%" fill="#eceeef" dy=".3em">История заказов</text>
        </svg>
      <div className="card-body">
        <p className="card-text">Здесь отображены заявки покупателей, которые были выкуплены или срок хранения которых истек.</p>
        <div className="d-flex justify-content-between align-items-center">
          <div className="btn-group">
            <Link type="Link" className="btn btn-sm btn-outline-secondary" to={'/request_history'}>Перейти</Link>
          </div>
        </div>
      </div>
    </div>
